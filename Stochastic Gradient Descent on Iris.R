...
stochasticgd = function(x, y, n, iter){
  ...
  print(c(t,training_loss,test_loss,training_accuracy,test_accuracy))
...
plot(seq(0,iter,takes),training_loss_list, col = 'blue', type = 'l', lwd = 2, main = 'Stochastic Gradient Descent on Iris Data Set', ylab = 'Cross Entropy Loss', xlab = 'Iteration')
lines(seq(0,iter,takes),test_loss_list, col = 'red', lwd = 2)

acc_check(final_beta,x_training,y_training)[1:10,]

confcalc(final_beta,x_training,y_training)
confcalc(final_beta,x_test,y_test)
